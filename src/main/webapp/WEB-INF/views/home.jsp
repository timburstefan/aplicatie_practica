...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Bine ai venit la magazinul online de articole muzicale</h1>

                    <p>Aici puteti procura diferite articole muzicale. De la instrumete si pana la accesori, toate sunt
                    la indemana voastra</p>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Lucruri pe care ar trebui sa le stii despre muzica</h1>

                    <p>Muzica este un fenomen care iti schimba starile de spirit.</p>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Este o bucurie a vietii</h1>

                    <p>Iti schimba starile sufletesti.</p>
